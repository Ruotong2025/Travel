package com.travel.ssm.blog.mapper;
...
public interface CommentMapper {
     ...
     * @return 评论列表
     */
    List<Comment> listNewCommentByArticleId(@Param(value = "articleId") Integer articleId,
                                           @Param(value = "lastCommentId") Integer lastCommentId);
}